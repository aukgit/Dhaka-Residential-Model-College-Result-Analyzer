Public Class Marks_Division
    ...
    Private Sub Marks_Division_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GSql.Sql_Gr_LikeUse_False("*", "Classoptions", "", Me.AuksoftDataSet2)
                    ...
                    If AcNPos > -1 Then
                        ...
                        For Qi = 5 To ((Csil - 1) + 5)
                            ...
                            If Nine = True Then 'Class 9 Generate
                                If Me.CheckBox1.Checked = True Then
                                    If GrdPos > -1 Then
                                        ...
                                        If (mn = 0 Or mn = 1) Or (mn = 2 Or mn = 3) Then
                                            ...
                                            End If
                                        Else
                                            If mn = 11 Then 'Class 9 or 10 's Optional Subjects Generate(Subject Number 11)
                                                If SubFail(Sb) = True Then
                                                    grnum = 0
                                                ...
                                                Else
                                                    ...
                                                    If Val(grnum) >= 2 Then
                                                        grnum = grnum - 2 'Optional Grading -2 if get 2
                                                    End If
                                                End If
                                                If Val(c) >= 40 Then
                                                    c = Val(c) - 40 'Optional Subject - 40 marks (class 9 or 10)
                                                End If
                                            Else
                                                If SubFail(Sb) = True Then
                                                    grnum = 0
                                ...
                                End If
                            End If
                            If Senior = True And Nine = False Then ' Class 11 is Started to Generate,Class XI
                                mn = (Qi - 4)
                                If mn = Csil Then 'Optional Subject generate (because, Qi is Equal 5+ and ,mn=1 at last, and first whole sub is csil and we go to as csil-1 so , mn=csil is now last subject which is optional)
                                    If FailIn(Sb) = True Then 'if Fail in Optional there is no  matter
                                        grnum = 0
                                        Me.AuksoftDataSet1.Grading(GrdPos).Item(Qi2) = "F"
                                    Else 'but if pass then
                                        grnum = AukF.NumAsGrdValue(c)
                                        grd = AukF.GradePointsToGrade(grnum)
                                        Me.AuksoftDataSet1.Grading(GrdPos).Item(Qi2) = grd
                                        If Val(grnum) >= 2 Then
                                    ...
                                    End If
                                    If Val(c) >= 40 Then
                                        c = Val(c) - 40 'Optional Subject - 40 marks (class 11) 
                                    End If
                                Else
                        ...
                        'End If
                        'starts the sending avg,abs,total ... Information and ReSheet
                        ...
                        If AukF.BindFind(Me.InformationIDBindingSource, "Collegeno", cgh) = True Then
                            Me.AuksoftDataSet1.InformationID(ComRow).Average_Subjects = Avgx
                            Me.AuksoftDataSet1.InformationID(ComRow).Failed_Subjectss = FailNum
                            Me.AuksoftDataSet1.InformationID(ComRow).Average_Subjects = Abs
                        ...
                        End If
                        'Class 9,10,11 .... Comments Distrubution
                        ...
                        ''''' ends distrubute
                        '' Grades Generate
                        If Nine = True And GrdPos > -1 Then 'if grdpos get and Class 9 to 10 then
                            dx = GTotal / 8 'Divide by 8 because all numbers get before ,Check to up...
                            wq = dx
                            If Val(wq) > 5 Then ' if total greater than 5 its became 5
                                wq = 5
                            ...
                            Me.AuksoftDataSet1.Grading(GrdPos).Total = AukF.GradePointsToGrade(GTotal / 8) ' get the Sign by AukCom ... If 80 its sends "A+"...
                        Else
                            dx = GTotal / 5 'if its class 11 then they have 6 subs and 1 is optional for this its divided by 5
                            wq = dx
                            'wq = AukF.NumAsGrdValue(dx)
                            If Val(wq) > 5 Then 'the same case
                                wq = 5
                            ElseIf Val(wq) < 0 Then
                                wq = 0
                            End If
                        ...
                        Else
                            'before check any prob  ''Me.AuksoftDataSet1.InformationID(I).Result = ResultStr
                        ...
                        'End If
                    End If
                ElseIf (Nine = False) And (Senior = True And Me.CheckBox1.Checked = True And TR.ToLower = "test") Then 'nine false ..... and senior and its must be class 12 and test Exam,Class XII
                    If AcNPos > -1 Then
                        TotalNum = 0
                        Avgx = 0
                        Abs = 0
                        ...
                        For Qi = 5 To ((Csil - 1) + 5)
                            ...
                            '<<Ends
                            GnW = Qi - 5
                            If GnW = 1 Or GnW = 3 Or GnW = 5 Or GnW = 7 Or GnW = 9 Or GnW = 11 Then 'In test of Class 12 there are 12 subjects and every subject are average by there own.. first count 1,3,5,7 etc.. and + and Divide by 2 to get Avgmrk
                                If GnW = 11 Then
                                    ...
                                    ElseIf (FailIn(GnW) = False) And (FailIn(GnW - 1) = False) Then
                                        ...
                                        SubSub1 = 0
                                        GTotal = GTotal + Val(grnum)
                                        If Val(c) >= 40 Then c = Val(c) - 40 ' if Any get 40+ in optional its get off Class XII
                                    End If
                                Else ' Any other subject of class 12
                                    If FailIn(GnW) = True Or FailIn(GnW - 1) = True Then
                                        If GrdPos > -1 Then
                                            gx = AukF.GradePointsToGrade(grnum)
                                            Me.AuksoftDataSet1.Grading(GrdPos).Item(Qi2 - 1) = "F"
                        ...
                        If AukF.BindFind(Me.InformationIDBindingSource, "Collegeno", cgh) = True Then
                            Me.AuksoftDataSet1.InformationID(ComRow).Average_Subjects = Avgx
                            Me.AuksoftDataSet1.InformationID(ComRow).Failed_Subjectss = FailNum
                            Me.AuksoftDataSet1.InformationID(ComRow).Absent_Subjects = Abs
                            Me.AuksoftDataSet1.InformationID(ComRow).LastTermExam = TR
                            Me.AuksoftDataSet1.InformationID(ComRow).TotalMarks = TotalNum
                ...
                Else 'trd = true
                    ...
                    If (AcNPos > -1) And (AcNConPos > -1) Then
                        ...
                        For Qi = 5 To ((Csil - 1) + 5)
                            ...
                            End If
                            If AukF.BindFind(Me.InformationIDBindingSource, "Collegeno", cgh) = True Then
                                Me.AuksoftDataSet1.InformationID(ComRow).Average_Subjects = Avgx2
                                Me.AuksoftDataSet1.InformationID(ComRow).Failed_Subjectss = FailNum2
                                Me.AuksoftDataSet1.InformationID(ComRow).Absent_Subjects = Abs2
                                Me.AuksoftDataSet1.InformationID(ComRow).LastTermExam = TR
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If Me.SubjectiveBindingSource.Count > 0 Then AukF2.AukOptionsOfDataGrid(Me.SUbjView, "", "", "3", "", "0,1,2,", "")
        If Me.ObjectiveBindingSource.Count > 0 Then AukF2.AukOptionsOfDataGrid(Me.ObjView, "", "", "3", "", "0,1,2", "")

        If Me.CheckBox1.Checked = True Then Me.DataGridView3.DataSource = Me.GradingBindingSource
        If Me.GradingBindingSource.Count > 0 Then AukF2.AukOptionsOfDataGrid(Me.DataGridView3, "", "", "3", "", "0,1,2", "")
    End Sub
    ...
    Private Sub BigSheetToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BigSheetToolStripMenuItem.Click
        Dim kp As New Object
        Dim B1 As New BigSheet3
        Dim SB As New ScienceBigSheetReport
        Dim HB As New HumanBigSheetReport
        Dim Cbig As New CommerceBigSheetReport
        If Val(Clx) >= 3 And Val(Clx) <= 8 Then
            kp = B1
        Else
            If Me.GValueTxt.ToLower = "science" Then
                kp = SB
            ElseIf Me.GValueTxt.ToLower = "human" Then
                kp = HB
            ElseIf Me.GValueTxt.ToLower = "commerce" Then
                kp = Cbig
            End If
        End If
        kp.Database.Tables(0).SetDataSource(Me.AuksoftDataSet1)
    ...
    Private Sub ToolStripMenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem2.Click
        ...
        Else
            ...
            End If
        End If
        kp.Subreports(0).ReportDefinition.Sections.Item(3).SectionFormat.EnableSuppress = True
        ReportViewer.Show()
        ReportViewer.CrystalReportViewer1.ReportSource = kp
    End Sub
    ...
    Private Sub Button14_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button14.Click
        ...
        If HighestmarksBindingSource.Count > 0 Then AukF2.AukOptionsOfDataGrid(Me.DataGridView1, "", "", "", "", "0,1", "")

        Me.DataGridView2.DataSource = Me.HighestmarksBindingSource1
        If HighestmarksBindingSource1.Count > 0 Then AukF2.AukOptionsOfDataGrid(Me.DataGridView2, "", "", "", "", "0,1", "")
