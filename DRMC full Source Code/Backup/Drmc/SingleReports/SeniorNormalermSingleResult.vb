...
Public Class SeniorNormalermSingleResult
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SeniorNormalermSingleResult.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSeniorNormalermSingleResult
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SeniorNormalermSingleResult = New SeniorNormalermSingleResult
        rpt.Site = Me.Site
        Return rpt
    End Function
