...
Public Class SSC_Single_Finalize2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SSC_Single_Finalize2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSC_Single_Finalize2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSC_Single_Finalize2 = New SSC_Single_Finalize2
        rpt.Site = Me.Site
        Return rpt
    End Function
