...
Public Class SScBlackSubjectsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SScBlackSubjectsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSScBlackSubjectsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SScBlackSubjectsReport = New SScBlackSubjectsReport
        rpt.Site = Me.Site
        Return rpt
    End Function
