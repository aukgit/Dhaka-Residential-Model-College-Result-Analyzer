...
Public Class Copy_of_WorkingDays
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of WorkingDays.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_WorkingDays
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_WorkingDays = New Copy_of_WorkingDays
        rpt.Site = Me.Site
        Return rpt
    End Function
