...
Public Class SudentsSubjectsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SudentsSubjectsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSudentsSubjectsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SudentsSubjectsReport = New SudentsSubjectsReport
        rpt.Site = Me.Site
        Return rpt
    End Function
