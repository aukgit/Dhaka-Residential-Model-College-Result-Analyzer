...
Public Class StudentsWholeRecord
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StudentsWholeRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStudentsWholeRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudentsWholeRecord = New StudentsWholeRecord
        rpt.Site = Me.Site
        Return rpt
    End Function
