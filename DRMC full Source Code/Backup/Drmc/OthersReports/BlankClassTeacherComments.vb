...
Public Class BlankClassTeacherComments
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BlankClassTeacherComments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBlankClassTeacherComments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BlankClassTeacherComments = New BlankClassTeacherComments
        rpt.Site = Me.Site
        Return rpt
    End Function
