...
Public Module AukSql
    ...
    Public Function FirstSqlAukCmDND(ByVal TitleNames As String, ByVal GrpT As String, ByVal Grp As Boolean, ByVal OrB As Boolean, ByVal OpenTableName As String, ByVal LikeOpt As Boolean)
        'Dim I As Integer
        Dim IpDw As Integer
        If Val(SqlNum) = 0 Then
            SqlNum = 14
        ElseIf Val(SqlNum) > 14 Then
            SqlNum = 14
        ElseIf Val(SqlNum) < 0 Then
            SqlNum = 14
        End If
        p = "') and"
        m = "='"
        For IpDw = 0 To Val(SqlNum)
            If Expre(IpDw) = "" Or ExpressionsQ(IpDw) = "" Then
                If Trim(SF(IpDw)) <> "" Then
                    If Trim(NM(IpDw)) = "" And Trim(EP(IpDw)) = "" And Trim(InP(IpDw)) = "" Then
                        If LikeOpt = False Then
                            If Trim(LK(IpDw)) <> "" Then
                                If NotOpt(IpDw) = True Then
                                    If ESum(IpDw) <> "" Then
                                        CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) Not Like '" & ST(IpDw) & "*')"
                                    Else
                                        CvObj(IpDw) = "([" & SF(IpDw) & "] Not Like '" & ST(IpDw) & "%')"
                                    End If
                                Else
                                    If ESum(IpDw) <> "" Then
                                        CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) like '" & ST(IpDw) & "*')"
                                    Else
                                        CvObj(IpDw) = "([" & SF(IpDw) & "] like '" & ST(IpDw) & "%')"
                                    End If
                                End If

                            Else
                                If NotOpt(IpDw) = True Then
                                    CvObj(IpDw) = "([" & SF(IpDw) & "]" & "<>'" & ST(IpDw) & "')"
                                Else
                                    CvObj(IpDw) = "([" & SF(IpDw) & "]" & m & ST(IpDw) & "')"
                                End If

                            End If
                        Else
                            If EP(IpDw) = "" And NM(IpDw) = "" Then
                                If NotOpt(IpDw) = False Then
                                    If ESum(IpDw) <> "" Then '
                                        CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "])" & " like '" & ST(IpDw) & "*')"
                                    Else
                                        CvObj(IpDw) = "([" & SF(IpDw) & "]" & " like '" & ST(IpDw) & "%')"
                            ...
                            End If
                        End If
                    ElseIf Trim(NM(IpDw)) = "" And Trim(EP(IpDw)) = "" And Trim(InP(IpDw)) <> "" Then
                        If NotOpt(IpDw) = True Then
                            If ESum(IpDw) <> "" Then
                                CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) Not In (" & ST(IpDw) & "))"
                            Else
                                CvObj(IpDw) = "([" & SF(IpDw) & "] Not In (" & ST(IpDw) & "))"
                            End If
                        Else
                            If ESum(IpDw) <> "" Then
                                CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) In (" & ST(IpDw) & "))"
                            Else
                                CvObj(IpDw) = "([" & SF(IpDw) & "] In (" & ST(IpDw) & "))"
                            End If
                        End If
                    Else

                        If Trim(EP(IpDw)) <> "" And Trim(InP(IpDw)) = "" Then
                            If Trim(LK(IpDw)) = "" Then
                                If ESum(IpDw) <> "" Then
                                    CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) " & EP(IpDw) & ST(IpDw) & ")"
                                Else
                                    CvObj(IpDw) = "([" & SF(IpDw) & "] " & EP(IpDw) & ST(IpDw) & ")"
                                End If
                            ElseIf Trim(LK(IpDw)) <> "" And Trim(InP(IpDw)) = "" Then
                                If ESum(IpDw) <> "" Then
                                    CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) Like " & EP(IpDw) & ST(IpDw) & ")"
                                Else
                                    CvObj(IpDw) = "([" & SF(IpDw) & "] Like " & EP(IpDw) & ST(IpDw) & ")"
                                End If
                            ElseIf Trim(LK(IpDw)) = "" And Trim(InP(IpDw)) <> "" Then
                                If ESum(IpDw) <> "" Then
                                    CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) " & EP(IpDw) & " In ( " & ST(IpDw) & "))"
                                Else
                                    CvObj(IpDw) = "([" & SF(IpDw) & "]) " & EP(IpDw) & " In ( " & ST(IpDw) & "))"
                                End If
                            End If
                        Else
                            CvObj(IpDw) = "([" & SF(IpDw) & "]=" & ST(IpDw) & ")"
            ...
            Else
                ...
                If ExpressionsQ(IpDw) = "" Then
                    If SF(IpDw) <> "" And Expre(IpDw) <> "" Then
                        CvObj(IpDw) = "([" & SF(IpDw) & "]" & "  " & Expre(IpDw) & ")"
                    End If
                Else
                    CvObj(IpDw) = ExpressionsQ(IpDw)
                End If
            End If
            ...
            If CvObj(IpDw) <> "" Then
                If strvX = "" Then
                    strvX = CvObj(IpDw)
                Else
                    If ANDOR_orTrue(IpDw) = True Then
                        strvX = strvX & " Or " & CvObj(IpDw)
                    Else
                        strvX = strvX & " and " & CvObj(IpDw)
                    End If
        ...
        strvX = ""
    End Function
    Public Function FirstSqlAukCmDND(ByVal TitleNames As String, ByVal GrpT As String, ByVal Grp As Boolean, ByVal OrB As Boolean, ByVal OpenTableName As String, ByVal LikeOpt As Boolean, ByVal AddExpression As String)
        'Dim I As Integer
        Dim IpDw As Integer
        If Val(SqlNum) = 0 Then
            SqlNum = 14
                    ...
                    Else
                        ...
                        If Trim(EP(IpDw)) <> "" And Trim(InP(IpDw)) = "" Then
                            ...
                            ElseIf Trim(LK(IpDw)) <> "" And Trim(InP(IpDw)) = "" Then
                                ...
                                End If
                            ElseIf Trim(LK(IpDw)) = "" And Trim(InP(IpDw)) <> "" Then
                                If NotOpt(pdw) = True Then
                                    If ESum(IpDw) <> "" Then
                                        CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) " & EP(IpDw) & " Not In ( " & ST(IpDw) & "))"
                                    Else
                                        CvObj(IpDw) = "([" & SF(IpDw) & "]) " & EP(IpDw) & " Not In ( " & ST(IpDw) & "))"
                                    End If
                                Else
                                    If ESum(IpDw) <> "" Then
                                        CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) " & EP(IpDw) & " In ( " & ST(IpDw) & "))"
        ...
        End If
        If OrB = True Then
            If AddExpression.Trim <> "" Then
                If strvX <> "" Then
                    Sql = "select " & TitleNames & " from [" & OpenTableName & "] where ( " & strvX & "and (" & AddExpression.Trim.ToUpper & ")" & ")" & GrpT
                Else
                    Sql = "select " & TitleNames & " from [" & OpenTableName & "] Where " & AddExpression.Trim.ToUpper & GrpT
                End If
            Else
        ...
        strvX = ""
    End Function
    Public Function SqlAukCmDND(ByVal TitleNames As String, ByVal GrpT As String, ByVal Grp As Boolean, ByVal OrB As Boolean, ByVal OpenTableName As String, Optional ByVal LikeOpt As Boolean = False, Optional ByVal LikeFromFirst As Boolean = False)
        Dim IpDw As Integer
        Dim Fs1, Fs2 As String
     
        If LikeOpt = True Then
            Fs1 = "%"
            Fs2 = Fs1

            If LikeFromFirst = True Then
                Fs1 = ""
                Fs2 = "%"
            End If
        Else
                    ...
                    If Trim(NM(IpDw)) = "" And Trim(EP(IpDw)) = "" And Trim(InP(IpDw)) = "" Then
                        If LikeOpt = False Then
                            If Trim(LK(IpDw)) <> "" Then
                                If NotOpt(IpDw) = True Then
                                    If ESum(IpDw) <> "" Then
                                        CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) Not Like '" & Fs1 & "" & ST(IpDw) & "" & Fs2 & "')"
                                    Else
                                        CvObj(IpDw) = "([" & SF(IpDw) & "] Not Like '" & Fs1 & "" & ST(IpDw) & "" & Fs2 & "')"
                                    End If
                                Else
                                    If ESum(IpDw) <> "" Then
                                        CvObj(IpDw) = "(" & ESum(IpDw) & "([" & SF(IpDw) & "]) like '" & Fs1 & "" & ST(IpDw) & "" & Fs2 & "')"
                                    Else
                                        CvObj(IpDw) = "([" & SF(IpDw) & "] like '" & Fs1 & "" & ST(IpDw) & "" & Fs2 & "')"
                                    End If
                                End If
                            Else
                                If NotOpt(IpDw) = True Then
...
cmnx:
        ...
        strvX = ""
    End Function
    Public Function SqlAukCmDND(ByVal TitleNames As String, ByVal GrpT As String, ByVal Grp As Boolean, ByVal OrB As Boolean, ByVal OpenTableName As String, ByVal LikeOpt As Boolean, ByVal AddExpression As String)
        Dim IpDw As Integer
        If Val(SqlNum) = 0 Then
            SqlNum = 14
        ElseIf Val(SqlNum) > 14 Then
    ...
    Public Function INPC(ByVal T As Object, ByVal T2 As Object, ByVal t3 As Object, ByVal T4 As Object, ByVal T5 As Object, ByVal T6 As Object, ByVal T7 As Object, ByVal T8 As Object, ByVal t9 As Object, ByVal T10 As Object, ByVal T11 As Object, ByVal T12 As Object, ByVal T13 As Object, ByVal T14 As Object, ByVal T15 As Object)
        ...
        If INP(12) = "" Then InP(12) = T13
        If InP(13) = "" Then InP(13) = T14
        If InP(14) = "" Then InP(14) = T15
    End Function
    Public Function ExpText(Optional ByVal T As Object = "", Optional ByVal T2 As Object = "", Optional ByVal t3 As Object = "", Optional ByVal T4 As Object = "", Optional ByVal T5 As Object = "", Optional ByVal T6 As Object = "", Optional ByVal T7 As Object = "", Optional ByVal T8 As Object = "", Optional ByVal t9 As Object = "", Optional ByVal T10 As Object = "", Optional ByVal T11 As Object = "", Optional ByVal T12 As Object = "", Optional ByVal T13 As Object = "", Optional ByVal T14 As Object = "", Optional ByVal T15 As Object = "")
        'Expression Text
        If ExpressionsQ(0) = "" Then ExpressionsQ(0) = T
        If ExpressionsQ(1) = "" Then ExpressionsQ(1) = T2
        If ExpressionsQ(2) = "" Then ExpressionsQ(2) = t3
        If ExpressionsQ(3) = "" Then ExpressionsQ(3) = T4
        If ExpressionsQ(4) = "" Then ExpressionsQ(4) = T5
        If ExpressionsQ(5) = "" Then ExpressionsQ(5) = T6
        If ExpressionsQ(6) = "" Then ExpressionsQ(6) = T7
        If ExpressionsQ(7) = "" Then ExpressionsQ(7) = T8
        If ExpressionsQ(8) = "" Then ExpressionsQ(8) = t9
        If ExpressionsQ(9) = "" Then ExpressionsQ(9) = T10
        If ExpressionsQ(10) = "" Then ExpressionsQ(10) = T11
        If ExpressionsQ(11) = "" Then ExpressionsQ(11) = T12
        If ExpressionsQ(12) = "" Then ExpressionsQ(12) = T13
        If ExpressionsQ(13) = "" Then ExpressionsQ(13) = T14
        If ExpressionsQ(14) = "" Then ExpressionsQ(14) = T15
    End Function
