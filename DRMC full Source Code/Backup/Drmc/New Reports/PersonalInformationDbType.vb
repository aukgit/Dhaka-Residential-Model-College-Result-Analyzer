...
Public Class PersonalInformationDbType
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PersonalInformationDbType.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPersonalInformationDbType
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PersonalInformationDbType = New PersonalInformationDbType
        rpt.Site = Me.Site
        Return rpt
    End Function
