...
Public Class ScienceBigSheetReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ScienceBigSheetReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScienceBigSheetReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScienceBigSheetReport = New ScienceBigSheetReport
        rpt.Site = Me.Site
        Return rpt
    End Function
