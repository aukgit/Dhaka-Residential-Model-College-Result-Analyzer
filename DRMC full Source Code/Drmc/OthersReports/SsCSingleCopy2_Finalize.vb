...
Public Class SsCSingleCopy2_Finalize
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SsCSingleCopy2_Finalize.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSsCSingleCopy2_Finalize
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SsCSingleCopy2_Finalize = New SsCSingleCopy2_Finalize
        rpt.Site = Me.Site
        Return rpt
    End Function
