...
Public Class Copy_of_SScBlackSubjectsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of SScBlackSubjectsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_SScBlackSubjectsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_SScBlackSubjectsReport = New Copy_of_SScBlackSubjectsReport
        rpt.Site = Me.Site
        Return rpt
    End Function
