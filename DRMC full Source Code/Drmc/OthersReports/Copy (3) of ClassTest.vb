...
Public Class Copy_3_of_ClassTest
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy (3) of ClassTest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_3_of_ClassTest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_3_of_ClassTest = New Copy_3_of_ClassTest
        rpt.Site = Me.Site
        Return rpt
    End Function
