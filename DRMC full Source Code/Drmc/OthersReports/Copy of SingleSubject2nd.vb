...
Public Class Copy_of_SingleSubject2nd
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of SingleSubject2nd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_SingleSubject2nd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_SingleSubject2nd = New Copy_of_SingleSubject2nd
        rpt.Site = Me.Site
        Return rpt
    End Function
