...
Public Class SeniorBlackSubjectsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SeniorBlackSubjectsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSeniorBlackSubjectsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SeniorBlackSubjectsReport = New SeniorBlackSubjectsReport
        rpt.Site = Me.Site
        Return rpt
    End Function
