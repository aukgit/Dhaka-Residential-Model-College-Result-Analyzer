...
j:
    ...
    Public Sub OpenLiquid(ByVal Convert As Boolean)
        ...
        '    End If
        'End If
        'DrmcModule.A_plusSt = Me.AuksoftDataSet1.MarksObtaint(0).Item(7)
        'DrmcModule.A_plusEn = Me.AuksoftDataSet1.MarksObtaint(0).Item(8)
        'DrmcModule.A_St = Me.AuksoftDataSet1.MarksObtaint(0).Item(9)
        'DrmcModule.A_En = Me.AuksoftDataSet1.MarksObtaint(0).Item(10)
        'DrmcModule.A_MinSt = Me.AuksoftDataSet1.MarksObtaint(0).Item(11)
        'DrmcModule.A_MinEn = Me.AuksoftDataSet1.MarksObtaint(0).Item(12)
        'DrmcModule.B_ST = Me.AuksoftDataSet1.MarksObtaint(0).Item(13)
        'DrmcModule.B_En = Me.AuksoftDataSet1.MarksObtaint(0).Item(14)
        'DrmcModule.C_ST = Me.AuksoftDataSet1.MarksObtaint(0).Item(15)
        'DrmcModule.C_En = Me.AuksoftDataSet1.MarksObtaint(0).Item(16)
        'DrmcModule.Fnum = Me.AuksoftDataSet1.MarksObtaint(0).Item(17)
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        Dim Snr4 As New SeniorNormalermSingleResult
            ...
            Else
                ...
                If Me.RadioButton3.Checked = True Then
                    ...
                    If yh > -1 Then
                        ...
                        ElseIf Me.T3rdConvertResChk.Checked = True And Ac1Sec = False Then
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        Else
            ...
            ElseIf Nine = False And Senior = True Then
                If GrptxtTx.ToLower = "science" Then
