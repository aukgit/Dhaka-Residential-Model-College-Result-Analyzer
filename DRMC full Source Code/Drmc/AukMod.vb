...
Public Module AukMod
    ...
    Public StrPass, StrSign As String
    Public ITnt As Integer = -1
    Public QFnd As String = ""
    Public OrdTableName As String = ""
    Public AddColDb(3) As String
    Public AddRwTxt(3) As String
    ...
    Public WhatDoso As String = "Are you want to do so...?"
    ...
    End Function
    Public Function Epx(ByVal Expression As String)
        vgb = "(Error Number : " & """" & Err.Number & """)" & vbCrLf & "(Description:" & vbCrLf & Err.Description & ")" & vbCrLf & "(Expression:" & Expression & ")"
        gb2 = "Error Source : " & Err.Source
        cfew = vgb & vbNewLine _
         & gb2
        MsgBox(cfew, MsgBoxStyle.Critical, "Contact With Developer Alim (01711334201[on Request],0193-500863)")

    End Function
    Public Function Epx(ByVal Expression As String, ByVal Tit As String)
        vgb = "(Error Number : " & """" & Err.Number & """)" & vbCrLf & "(Description:" & vbCrLf & Err.Description & ")" & vbCrLf & "(Expression:" & Expression & ")"
        gb2 = "Error Source : " & Err.Source
        cfew = vgb & vbNewLine _
         & gb2
        MsgBox(cfew, MsgBoxStyle.Critical, Tit)
