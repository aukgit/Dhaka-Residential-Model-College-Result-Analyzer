Public Class Terminal2
            ...
            If Me.Acc2ConvertBindingSource.Filter = "" Then
                If c = -1 Then
                    ...
                    Try
                        ...
                        Me.AuksoftDataSet1.Acc2Convert.Rows(I).Item(1) = MainID
            ...
            If Me.Acc2ConvertBindingSource.Filter = "" And Me.Acc2ConvertBindingSource1.Filter = "" Then
                ...
                If c = -1 Then
                    Try
                        ...
                        Me.AuksoftDataSet2.Acc2Convert.Rows(I).Item(1) = MainID
    ...
    Public Function CerKit(ByVal Num As String)
        CerKit = AukF.DrmcPoints(Job, (Num), Me.makehalf.Text, Me.make1.Text)
    End Function
    ...
    Private Sub MainQuerymanagerToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MainQuerymanagerToolStripMenuItem.Click
        If AukF.MsgTr("Are you want to Save Before Query New...?") = True Then
            Saved()
        End If
        Me.Hide()
        QueryManager.Show()
    ...
    Private Sub InputAllCollegeNoToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles InputAllCollegeNoToolStripMenuItem.Click
        ...
        Try
            ...
            For m = 0 To dx
                ...
                xe = Me.AuksoftDataSet1.InformationID.Rows(m).Item(2).ToString
                'MsgBox(xe, , m)
                InsCol2(xe)
                Me.ProgressBar1.Value = Me.ProgressBar1.Value + g

            Next
            Working = False
            Me.Single3To8SubjectsNumbersBindingSource.MoveFirst()
            Me.ProgressBar1.Visible = False
        Catch ex As Exception
            Epx()
            If AukF.MsgTr("Are you want to Exit From Function?") = True Then
                Working = False
                Exit Sub
            End If
        Finally
    ...
    Private Sub Button7_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            Me.MarksObtaintBindingSource.EndEdit()
            nu.Item(18) = nu(7).ToString & "%-" & nu(8).ToString & "%"
            nu.Item(19) = nu(9).ToString & "%-" & nu(10).ToString & "%"
            nu.Item(20) = nu(11).ToString & "%-" & nu(12).ToString & "%"
            nu.Item(21) = nu(13).ToString & "%-" & nu(14).ToString & "%"
            nu.Item(22) = nu(15).ToString & "%-" & nu(16).ToString & "%"
            nu.Item(23) = nu(17).ToString & "% or below"
            Me.MarksObtaintBindingSource.EndEdit()
            Me.MarksObtaintTableAdapter.Update(Me.AuksoftDataSet1.MarksObtaint)
...
byu:
    ...
    Private Sub GetErrorInformationToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetErrorInformationToolStripMenuItem.Click
        Dim rty As String
        rty = ""
    ...
    Private Sub SingleSubjectToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SingleSubjectToolStripMenuItem.Click
        Try
            Me.ViewGrid.DataSource = ""
    ...
    Private Sub TotalResultToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TotalResultToolStripMenuItem.Click
        Try
            Me.ViewGrid.DataSource = ""
    ...
    Private Sub DaysOfWorksToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DaysOfWorksToolStripMenuItem.Click
        Try
            Me.ViewGrid.DataSource = ""
        ...
        Try
            ...
            For I = 0 To (Me.InformationIDBindingSource.Count - 1)
                ...
                If d = -1 Then
                    ...
                    '    End If
                End If
                Me.CtProg.Value = Me.CtProg.Value + c
    ...
    Private Sub ClassTestToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClassTestToolStripMenuItem1.Click
        Try
    ...
    Private Sub ClassTestToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClassTestToolStripMenuItem.Click
        Try
