...
Public Class CommerceBigSheetReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CommerceBigSheetReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCommerceBigSheetReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CommerceBigSheetReport = New CommerceBigSheetReport
        rpt.Site = Me.Site
        Return rpt
    End Function
