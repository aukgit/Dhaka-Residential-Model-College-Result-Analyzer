...
Public Class HumanBigSheetReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "HumanBigSheetReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHumanBigSheetReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HumanBigSheetReport = New HumanBigSheetReport
        rpt.Site = Me.Site
        Return rpt
    End Function
